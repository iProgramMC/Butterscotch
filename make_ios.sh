...
make \
	...
	OS=iOS \
	DISABLE_MODERN_GL=1 \
	CFLAGS="-target armv7-apple-darwin9 -isysroot $THEOS/sdks/iPhoneOS3.1.3.sdk -ObjC -DIPHONE_OS_3 -O3 -DNDEBUG" \
	LDFLAGS="-target armv7-apple-darwin9 -isysroot $THEOS/sdks/iPhoneOS3.1.3.sdk" \
